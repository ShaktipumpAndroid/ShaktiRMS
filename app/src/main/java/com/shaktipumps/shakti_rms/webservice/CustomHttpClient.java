...
public class CustomHttpClient {
    ...
    // public static final int HTTP_TIMEOUT = 60 * 1000; // milliseconds  // 1 minute
    public static final int HTTP_TIMEOUT = 2 * 60 * 1000; // milliseconds  // 2 minute
    ...
    public static String executeHttpGet(String url) throws Exception {
        ...
        try
        {
          ...
          e.printStackTrace();
            ...
            //System.out.println("shrii==>>"+e.printStackTrace());
            return new String("Exception: " + e.getMessage());
        }
    }
}
