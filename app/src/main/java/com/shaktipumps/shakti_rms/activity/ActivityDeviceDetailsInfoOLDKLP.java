...
import com.shaktipumps.shakti_rms.bean.OLD_klp.OldKLPModel;
import com.shaktipumps.shakti_rms.bean.OLD_klp.OldKLPResponse;
import com.shaktipumps.shakti_rms.fragment.OldKlp.DashboardFragmentOldKLPGrid;
import com.shaktipumps.shakti_rms.fragment.OldKlp.DashboardFragmentOldKLPMotor;
...
public class ActivityDeviceDetailsInfoOLDKLP extends AppCompatActivity {
  ...
  //  private TextView txtTotalEnergyHeadingID, txtConsumptionHeadingID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_device_details_info_old_klp);
        mContext = this;
        mActivity = this;
    ...
    private void initView() {
     ...
     //    addEnergyGraphFun();
        ...
        if(CustomUtility.isOnline(mContext)){
            ...
            swipeRefresh.setRefreshing(false);
            mOldKLPResponse = mDatabaseHelperTeacher.getDeviceOLDKLPDATA(vDeviceType);
...
/******************************************************************************************/
    ...
    private void callTotalEnergyAndConjuptionAPI() {
        ...
        baseRequest.setBaseRequestListner(new RequestReciever() {
            ...
            public void onSuccess(int APINumber, String Json, Object obj) {
                ...
                try {
                    ...
                    OldKLPModel mOldKLPModel = gson.fromJson(Json, OldKLPModel.class);
                    getTotalEndAndConsuptionsResponse(mOldKLPModel);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        baseRequest.callAPIPost(1, jsonObject, NewSolarVFD.ORG_TOTAL_GRIDTIE_oldKLP_ENERGY);/////
    }

    private void getTotalEndAndConsuptionsResponse(OldKLPModel mOldKLPModel) {
        ...
        if (mOldKLPModel.getStatus())
        {
            if(mOldKLPResponse != null )
                mOldKLPResponse = null;

           // mTotalEndAndConsuptionsModelView = mWelcomeModelView.getResponse();
            mOldKLPResponse = mOldKLPModel.getResponse();

            //total_fault = mTotalEndAndConsuptionsResponse.getTotalFault();
            current_fault = mOldKLPResponse.getTotalFault();

            mDatabaseHelperTeacher.insertDeviceOldKLPData(vMUserId, vMDeviceId, vDeviceNo, vDeviceType,mOldKLPResponse,mCheckFirst);
    ...
    private Fragment callFragHome(Fragment fragment1) {
        ...
        fragment1 = new DashboardFragmentOldKLPGrid(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType, mOldKLPResponse);
        return fragment1;
    }
    ...
    private Fragment callFragVFD(Fragment fragment1) {
        ...
        fragment1 = new DashboardFragmentOldKLPMotor(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType, mOldKLPResponse);
        return fragment1;
    }
