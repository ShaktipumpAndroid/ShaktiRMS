...
import com.shaktipumps.shakti_rms.fragment.shimaTwoO.DashboardShimhaMotorFragmentTwoO;
import com.shaktipumps.shakti_rms.fragment.shimaTwoO.DashboardShimhaPVFragmentTwoO;
...
public class ActivityDeviceDetailsInfoShimaTwoO extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_device_details_info_shima_two_o);
        mContext = this;
...
//                        editor.putString("key_time_zone_change", "Invalid");
    ...
    private void callTotalEnergyAndConjuptionAPI() {
       ...
       // baseRequest.callAPIPost(1, jsonObject, NewSolarVFD.ORG_TOTAL_SHIMA_ENERGY);/////
        baseRequest.callAPIPostShimha2(1, jsonObject, NewSolarVFD.ORG_TOTAL_SHIMA2_ENERGY);/////
    }
    ...
    private Fragment callFragPV(Fragment fragment1) {
        ...
        fragment1 = new DashboardShimhaPVFragmentTwoO(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType, mShimaResponse);
        return fragment1;
    }
    ...
    private Fragment callFragVFD(Fragment fragment1) {
        ...
        fragment1 = new DashboardShimhaMotorFragmentTwoO(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType, mShimaResponse);
        return fragment1;
    }
