...
import com.shaktipumps.shakti_rms.adapter.AoneSSBTPairedDeviceAdapternologin;
...
public class AoneSSPairedDeviceActivitynoLogin extends AppCompatActivity {
    ...
    private void pairedDeviceList() {
        ...
        if(bAdapter==null){
            ...
            if(pairedDevices.size()>0){
                ...
                // recyclerViewAdapter = new HomeOrderAdapter("sss",getActivity());
                recyclerViewAdapter = new AoneSSBTPairedDeviceAdapternologin(mContext, mDeviceNameList,mDeviceMACAddressList);
