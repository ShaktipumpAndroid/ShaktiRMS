...
public class Wifi_Parameters_GetSet_Activity extends AppCompatActivity implements View.OnClickListener , TelnetNotificationHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wifi_parameters_getset_activity);
...
///vikassss
    ...
    private void initView() {
        ...
        else
        {
            ...
            btnunbalancecurrentset.setVisibility(View.GONE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_settings:
                Intent j = new Intent(Wifi_Parameters_GetSet_Activity.this, SettingsActivity.class);
                startActivityForResult(j, 0);
                break;
            default:
    ...
    private class BluetoothCommunicationGetActions extends AsyncTask<String, Void, Boolean>  // UI thread
    {
        ...
        protected Boolean doInBackground(String... requests) //while the progress dialog is shown, the connection is done in background
        {
            ...
            try {
               ...
               // out.write(22);
                System.out.println("requests[0]"+requests[0]);
               ...
               // out.write(2);
                ...
                // btSocket.getOutputStream().write(STARTRequest);
                int sisisi = in.available();
                System.out.println("sisisi=="+sisisi);
                Log.d(TAG, "in.available(): "+in.available()+"vvv");
                    ...
                    //if(in.available() > 0)
                    {
                        ...
                        if(bytesRead>0) {
                            System.out.println("aad1==" + (char) bytesRead);
                        }
