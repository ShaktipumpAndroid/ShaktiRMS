...
import com.shaktipumps.shakti_rms.adapter.BTDemoMQTTAdapter;
...
public class Activity_pairdevice_for_mqtt extends AppCompatActivity {
    ...
    private void pairedDeviceList() {
        ...
        if(bAdapter==null){
            ...
            if(pairedDevices.size()>0){
                ...
                // recyclerViewAdapter = new HomeOrderAdapter("sss",getActivity());
                recyclerViewAdapter = new BTDemoMQTTAdapter(mContext, mDeviceNameList,mDeviceMACAddressList);
