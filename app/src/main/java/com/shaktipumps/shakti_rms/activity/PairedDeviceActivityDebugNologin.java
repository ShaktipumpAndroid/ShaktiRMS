...
import com.shaktipumps.shakti_rms.adapter.BTPairedDeviceAdapterDebugNologin;
...
public class PairedDeviceActivityDebugNologin extends AppCompatActivity {
    ...
    private void pairedDeviceList() {
        ...
        if(bAdapter==null){
            ...
            if(pairedDevices.size()>0){
                ...
                recyclerViewAdapter = new BTPairedDeviceAdapterDebugNologin(mContext, mDeviceNameList,mDeviceMACAddressList);
