...
import com.shaktipumps.shakti_rms.fragment.shima.DashboardShimhaMotorFragment;
import com.shaktipumps.shakti_rms.fragment.shima.DashboardShimhaPVFragment;
...
public class ActivityDeviceDetailsInfoShima extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_device_details_info_shima);
        mContext = this;
...
//                        editor.putString("key_time_zone_change", "Invalid");
    ...
    private Fragment callFragPV(Fragment fragment1) {
        ...
        fragment1 = new DashboardShimhaPVFragment(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType, mShimaResponse);
        return fragment1;
    }
    ...
    private Fragment callFragVFD(Fragment fragment1) {
        ...
        fragment1 = new DashboardShimhaMotorFragment(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType, mShimaResponse);
        return fragment1;
    }
