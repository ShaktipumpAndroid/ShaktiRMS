...
public class GetBTDATAWithoutLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_btdatalist_nologin);
        mContext = this;
        initView();
    }
    ...
    private void initView() {
        ...
        cardCMDDongleID.setVisibility(View.GONE);
        ...
        /*if (mModelType.equalsIgnoreCase("17")) {
            ...
            cardOneYearID.setVisibility(View.VISIBLE);//VISIBLE
            cardFiveYearID.setVisibility(View.VISIBLE);
            cardFifteenDaysID.setVisibility(View.VISIBLE);
          ...
          // lvlMainDataViewContaonerId.setWeightSum(3f);
            ...
            cardOneYearID.setVisibility(View.GONE);
            cardFiveYearID.setVisibility(View.GONE);
            cardFifteenDaysID.setVisibility(View.GONE);
            cardFaultsID.setVisibility(View.GONE);
            cardCMDDongleID.setVisibility(View.GONE);
...
*/
      ...
      /*  txtPlusZommBTNID.setOnClickListener(new View.OnClickListener() {
        ...
        rlvOneYearBTNID.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                new BluetoothCommunicationGetONEYearParameter().execute(":YLENGTH#", ":MDATA#", "START");
            }
        });
                    ...
                    while (true) {
                        ...
                        */
                                ...
                                if (((mvDay == 255) && (mvMonth == 255) && (mvYear == 255)) || ((mvDay == 0) && (mvMonth == 255) && (mvYear == 255))) {
                                    ...
                                    GetBTDATAWithoutLoginActivity.this.runOnUiThread(new Runnable() {
                                        @Override
                                        public void run() {
                                            ///  addHeadersMonths();
                                            addHeadersMonths();
                                ...
                                /*try {
                                    ...
                                    for (int j = 6; j < mMonthHeaderList.size(); j++) {
                                        //     fTotalEnergy = Float.intBitsToFloat(mDayDataList.get(i)[j]);
                                        sheet1.setColumnWidth(j, (10 * 200));
                                        fFrequency = Float.intBitsToFloat(mTotalTime[j]);
            ...
            try {
                ...
                if (btSocket.isConnected()) {
                    ...
                    while (true) {
                        ...
                        float fTotalTime = 0;
                        System.out.println("mBoolflag==>>"+mBoolflag);
                        if (!mBoolflag) {
                      ...
                      //  if (((mDay == 255) && (mMonth == 255) && (mYear == 255)) || ((mDay == 0) || (mMonth == 0) || (mYear == 0)))
                        ...
                        if (((mDay == 255) || (mMonth == 255) || (mYear == 255)) || ((mDay == 0) || (mMonth == 0) || (mYear == 0)))
                        {
                            ...
                            System.out.println("Save_File==>>1");
                            ...
                            try {
                                ...
                                try {
                                    os = new FileOutputStream(file_day);
                                    wb.write(os);
                                    System.out.println("Save_File==>>2");
                                    if (null != os)
                                        os.close();
                                } catch (Exception ex) {
                                    //    baseRequest.hideLoader();
                            ...
                            for (int i = 0; i < mS.length; i++) {
                                ...
                                if (!mS[i].trim().equalsIgnoreCase("") || !mS[i].trim().equalsIgnoreCase(null)) {
                                    ...
                                    GetBTDATAWithoutLoginActivity.this.runOnUiThread(new Runnable() {
                                        @Override
                                        public void run() {
                                            new GetBTDATAWithoutLoginActivity.BluetoothCommunicationGetFaultParameter().execute(":DLENGTH#", ":DLENGTH#", "OKAY");
                                        }
                                    });
        ...
        protected void onPostExecute(Boolean result) //after the doInBackground, it checks if everything went fine
        {
            ...
            if (mMonthHeaderList.size() > 0) {
                ...
                GetBTDATAWithoutLoginActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        new GetBTDATAWithoutLoginActivity.BluetoothCommunicationGetFaultParameter().execute(":FLENGTH#", ":FLENGTH#", "OKAY");
                    }
                });
            }
...
//                   String SS =convertStreamToString();
    ...
    @SuppressLint("StaticFieldLeak")
    private class BluetoothCommunicationGetONEYearParameter extends AsyncTask<String, Void, Boolean>  // UI thread
    {
        public int RetryCount = 0;
        private String response;
        private int bytesRead;
...
//                   String SS =convertStreamToString();
        ...
        protected void onPostExecute(Boolean result) //after the doInBackground, it checks if everything went fine
        {
            ...
            // baseRequest.hideLoader();
            if (mMonthHeaderList.size() > 0) {
                new BluetoothCommunicationForONEYEARDATA().execute(":YDATA#", ":MDATA#", "START");
            } else {
                GetBTDATAWithoutLoginActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        new GetBTDATAWithoutLoginActivity.BluetoothCommunicationGetONEYearParameter().execute(":YLENGTH#", ":MLENGTH#", "OKAY");
                    }
                });
            }
        }
        ...
        protected void onPostExecute(Boolean result) //after the doInBackground, it checks if everything went fine
        {
            ...
            if (mMonthHeaderList.size() > 0) {
                ...
                GetBTDATAWithoutLoginActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        new GetBTDATAWithoutLoginActivity.BluetoothCommunicationGetMonthParameter().execute(":MLENGTH#", ":MLENGTH#", "OKAY");
                    }
                });
            }
        }
