...
import com.shaktipumps.shakti_rms.bean.Nikola.NikolaModel;
import com.shaktipumps.shakti_rms.bean.Nikola.NikolaResponse;
import com.shaktipumps.shakti_rms.fragment.Nikola.DashboardFragmentNikolaBattery;
import com.shaktipumps.shakti_rms.fragment.Nikola.DashboardFragmentNikolaGrid;
import com.shaktipumps.shakti_rms.fragment.Nikola.DashboardFragmentNikolaLoad;
...
public class ActivityDeviceDetailsInfoNikola extends AppCompatActivity {
    ...
    private ImageView imgLoadID, imgBatteryID;
    private String TAG;

    private ViewPagerAdapter adapter;
    // private ViewPager viewPager;
    private CustomViewPager viewPager;
    private int mSwipePosition = 3;
    ...
    private TextView txtLoadID, txtBatteryID;

    private RelativeLayout rlvTabControleViewID, rlvTabGridViewID, rlvTabLoadViewID, rlvTabBatteryViewID;
    ...
    private int PagePositionIndex = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_device_details_info_nikola);
        mContext = this;
        mActivity = this;
    ...
    private void initView() {
        ...
        rlvTabGridViewID = (RelativeLayout) findViewById(R.id.rlvTabGridViewID);
        rlvTabLoadViewID = (RelativeLayout) findViewById(R.id.rlvTabLoadViewID);
        rlvTabBatteryViewID = (RelativeLayout) findViewById(R.id.rlvTabBatteryViewID);
        rlvTabControleViewID = (RelativeLayout) findViewById(R.id.rlvTabControleViewID);
        ...
        txtBatteryID = (TextView) findViewById(R.id.txtBatteryID);
        txtGridID = (TextView) findViewById(R.id.txtGridID);

        imgLoadID = (ImageView) findViewById(R.id.imgLoadID);
        imgBatteryID = (ImageView) findViewById(R.id.imgBatteryID);
        ...
        rlvTabGridViewID.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ///image
                txtHomeID.setImageResource(R.drawable.iv_grid_selected);
                imgBatteryID.setImageResource(R.drawable.battery_gray);
                imgLoadID.setImageResource(R.drawable.load_gray);
                ...
                txtLoadID.setTextColor(getResources().getColor(R.color.dark_bg_grey));
                txtBatteryID.setTextColor(getResources().getColor(R.color.dark_bg_grey));
        ...
        rlvTabLoadViewID.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                imgLoadID.setImageResource(R.drawable.load_blue);
                imgBatteryID.setImageResource(R.drawable.battery_gray);
                ...
                txtLoadID.setTextColor(getResources().getColor(R.color.blue_fb));
                txtBatteryID.setTextColor(getResources().getColor(R.color.dark_bg_grey));
                txtSettingID.setTextColor(getResources().getColor(R.color.dark_bg_grey));
                //  txtGraphID.setTextColor(getResources().getColor(R.color.black));
        ...
        rlvTabBatteryViewID.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                imgLoadID.setImageResource(R.drawable.load_gray);
                imgBatteryID.setImageResource(R.drawable.battery_blue);
                txtHomeID.setImageResource(R.drawable.iv_grid_unselected);
                //  txtDataID.setTextColor(getResources().getColor(R.color.white));
                txtGraphID.setImageResource(R.drawable.settings_unselected);
                ...
                txtGridID.setTextColor(getResources().getColor(R.color.dark_bg_grey));
                txtLoadID.setTextColor(getResources().getColor(R.color.dark_bg_grey));
                txtBatteryID.setTextColor(getResources().getColor(R.color.blue_fb));
                txtSettingID.setTextColor(getResources().getColor(R.color.dark_bg_grey));
                //  txtGraphID.setTextColor(getResources().getColor(R.color.black));
                viewPager.setCurrentItem(2);
            }
        });
        rlvTabControleViewID.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
            ...
            public void onRefresh() {
               ...
               /* PagePositionIndex = viewPager.getCurrentItem();
                ...
                if(CustomUtility.isOnline(mContext)){
                    ...
                    mDatabaseHelperTeacher.getDeviceNikolaDATA(vDeviceType);
                }
            }
        });
        ...
        if(CustomUtility.isOnline(mContext)){
            ...
            swipeRefresh.setRefreshing(false);
            mNikolaResponse = mDatabaseHelperTeacher.getDeviceNikolaDATA(vDeviceType);
...
/******************************************************************************************/
    ...
    private void callTotalEnergyAndConjuptionAPI() {
        ...
        baseRequest.setBaseRequestListner(new RequestReciever() {
            ...
            public void onSuccess(int APINumber, String Json, Object obj) {
                ...
                try {
                    ...
                    swipeRefresh.setRefreshing(false);
                    NikolaModel mNikolaModel = gson.fromJson(Json, NikolaModel.class);
                    getTotalEndAndConsuptionsResponse(mNikolaModel);
                } catch (Exception e) {
        ...
        baseRequest.callAPIPost(1, jsonObject, NewSolarVFD.ORG_TOTAL_NIKOLA_ENERGY);/////
    }

    private void getTotalEndAndConsuptionsResponse(NikolaModel mNikolaModel) {
        ...
        if (mNikolaModel.getStatus()) {
            if (mNikolaResponse != null)
                mNikolaResponse = null;

            // mTotalEndAndConsuptionsModelView = mWelcomeModelView.getResponse();
            mNikolaResponse = mNikolaModel.getResponse();
            
            //total_fault = mTotalEndAndConsuptionsResponse.getTotalFault();
            current_fault = mNikolaResponse.getFault();

            mDatabaseHelperTeacher.insertDeviceNikolaData(vMUserId, vMDeviceId, vDeviceNo, vDeviceType,mNikolaResponse,mCheckFirst);
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    ...
                    break;
                case 1:
                    fragment = callFragLoad(fragment);
                    //fragment = callFrag(fragment);
                    break;
                case 2:
                    fragment = callFragBattery(fragment);
                    //fragment = callFrag(fragment);
                    break;
                case 3:
                    fragment = callFrag(fragment);
    ...
    private Fragment callFragHome(Fragment fragment1) {
        ...
        fragment1 = new DashboardFragmentNikolaGrid(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType, mNikolaResponse);
        return fragment1;
    }

    private Fragment callFragLoad(Fragment fragment1) {
        try {
        ...
        fragment1 = new DashboardFragmentNikolaLoad(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType, mNikolaResponse);
        return fragment1;
    }


    private Fragment callFragBattery(Fragment fragment1) {
        try {
        ...
        fragment1 = new DashboardFragmentNikolaBattery(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType, mNikolaResponse);
        return fragment1;
    }
