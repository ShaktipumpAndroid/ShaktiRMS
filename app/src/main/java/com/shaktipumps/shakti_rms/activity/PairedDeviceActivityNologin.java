...
import com.shaktipumps.shakti_rms.adapter.BTPairedDeviceAdapterNologin;
...
public class PairedDeviceActivityNologin extends AppCompatActivity {
    ...
    private void pairedDeviceList() {
        ...
        if(bAdapter==null){
            ...
            if(pairedDevices.size()>0){
                ...
                recyclerViewAdapter = new BTPairedDeviceAdapterNologin(mContext, mDeviceNameList,mDeviceMACAddressList);
