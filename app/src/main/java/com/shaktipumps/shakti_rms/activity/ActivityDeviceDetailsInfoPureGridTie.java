...
import com.shaktipumps.shakti_rms.bean.GritTieSeventeen.GridTieSeventeenModel;
import com.shaktipumps.shakti_rms.bean.GritTieSeventeen.GridTieSeventeenResponse;
import com.shaktipumps.shakti_rms.fragment.GridtieSeventeenFag.DashboardFragmentGridTieSeventeen;
...
public class ActivityDeviceDetailsInfoPureGridTie extends AppCompatActivity {
  ...
  //  private TextView txtTotalEnergyHeadingID, txtConsumptionHeadingID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_device_details_info_pure_gridtie);
        mContext = this;
        mActivity = this;
...
/******************************************************************************************/
    ...
    private void callTotalEnergyAndConjuptionAPI() {
        ...
        baseRequest.setBaseRequestListner(new RequestReciever() {
            ...
            public void onSuccess(int APINumber, String Json, Object obj) {
                ...
                try {
                    ...
                    GridTieSeventeenModel mGridTieSeventeenModel = gson.fromJson(Json, GridTieSeventeenModel.class);
                    getTotalEndAndConsuptionsResponse(mGridTieSeventeenModel);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        //baseRequest.callAPIPost(1, jsonObject, Constant.GET_ALL_NOTIFICATION_LIST_API);/////
             baseRequest.callAPIPost(1, jsonObject, NewSolarVFD.ORG_GRIDTIE_SEVENTEEN_ENERGY);/////
    }

    private void getTotalEndAndConsuptionsResponse(GridTieSeventeenModel mGridTieSeventeenModel) {
        ...
        if (mGridTieSeventeenModel.getStatus())
        {
            if(mGridTieSeventeenResponse != null )
                mGridTieSeventeenResponse = null;

           // mTotalEndAndConsuptionsModelView = mWelcomeModelView.getResponse();
            mGridTieSeventeenResponse = mGridTieSeventeenModel.getResponse();

            //total_fault = mTotalEndAndConsuptionsResponse.getTotalFault();
            current_fault = mGridTieSeventeenResponse.getTotalFault();
    ...
    private Fragment callFragHome(Fragment fragment1) {
        ...
        fragment1 = new DashboardFragmentGridTieSeventeen(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType, mGridTieSeventeenResponse);
        return fragment1;
    }
