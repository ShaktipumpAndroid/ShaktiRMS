...
import com.shaktipumps.shakti_rms.bean.KLPGrid.KLPGridModelView;
import com.shaktipumps.shakti_rms.fragment.KLPGridFrag.DashboardFragmentKLPGrid;
...
public class ActivityDeviceDetailsInfoKLPGrid extends AppCompatActivity {
   ...
   // private TextView txtDataID,txtGraphID;
    private ImageView txtGraphID, txtHomeID;
    private String TAG;
  ...
  //  private TextView txtTotalEnergyHeadingID, txtConsumptionHeadingID;
    ...
    private TextView txtSettingID,  txtGridID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_device_details_info_klp_grid);
        setContentView(R.layout.activity_device_details_info_klp_grid);
        mContext = this;
        mActivity = this;
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if(CustomUtility.isOnline(mContext)){
                    ...
                    mKLPGridModelResponse = mDatabaseHelperTeacher.getDeviceKLPGRIDDATA(vDeviceType);
...
/******************************************************************************************/
                            ...
                            msg2.obj = getString(R.string.action_delete_device);
    ...
    private void callTotalEnergyAndConjuptionAPI() {
        ...
        baseRequest.setBaseRequestListner(new RequestReciever() {
            ...
            public void onSuccess(int APINumber, String Json, Object obj) {
                ...
                try {
                    ...
                    KLPGridModelView mKLPGridModelView = gson.fromJson(Json, KLPGridModelView.class);
                    getTotalEndAndConsuptionsResponse(mKLPGridModelView);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        //baseRequest.callAPIPost(1, jsonObject, Constant.GET_ALL_NOTIFICATION_LIST_API);/////
             baseRequest.callAPIPost(1, jsonObject, NewSolarVFD.ORG_TOTAL_KLP_GRID_ENERGY);/////
    }

    private void getTotalEndAndConsuptionsResponse(KLPGridModelView mKLPGridModelView) {
        ...
        if (mKLPGridModelView.getStatus())
        {
            baseRequest.hideLoader();
            if(mKLPGridModelResponse != null )
                mKLPGridModelResponse = null;

           // mTotalEndAndConsuptionsModelView = mWelcomeModelView.getResponse();
            mKLPGridModelResponse = mKLPGridModelView.getResponse();

            //total_fault = mTotalEndAndConsuptionsResponse.getTotalFault();
            current_fault = mKLPGridModelResponse.getTotalFault();

            mDatabaseHelperTeacher.insertDeviceKLPGRIDData(vMUserId, vMDeviceId, vDeviceNo, vDeviceType,mKLPGridModelResponse,mCheckFirst);
    ...
    private Fragment callFragHome(Fragment fragment1) {
        ...
        fragment1 = new DashboardFragmentKLPGrid(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType, mKLPGridModelResponse);
        return fragment1;
    }
    ...
    private Fragment callFrag(Fragment fragment1) {
        ...
        fragment1 = new StartStopFragmentKLP(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType);
        return fragment1;
    }
    ...
    private void SideMenuInitView(int OEM_Check)
    {
        ...
        rlvMenuOptionRemoveDeviceViewID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Constant.CHECK_FOR_WORK_WITH_BT_OR_IN == 0) {
                    ...
                    mDatabaseHelperTeacher.AllDeviceDdelete("deviceklpgridtableble", DeviceType);
                    delete_from_server();
       ...
       // txtAppVersionID.setText(version);
        ...
        rlvMenuOptionAddDeviceViewID.setVisibility(View.GONE);
        System.out.println("Constant.CHECK_COUNT_OF_DELETE==>"+Constant.CHECK_COUNT_OF_DELETE);
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (Constant.CHECK_FOR_WORK_WITH_BT_OR_IN == 0) {
                          ...
                          //  AllDeviceDdelete(String mTableName, String mDeviceType)
                            //  delete_device_confirmation();
                            delete_from_server();
