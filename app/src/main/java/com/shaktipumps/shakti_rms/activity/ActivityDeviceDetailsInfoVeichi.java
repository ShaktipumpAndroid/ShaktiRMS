...
import com.shaktipumps.shakti_rms.bean.ViechiBean.ViechiDataModel;
...
import com.shaktipumps.shakti_rms.fragment.Veichi.DashboardVeichiMotorFragment;
import com.shaktipumps.shakti_rms.fragment.Veichi.DashboardVeichiPVFragment;
...
public class ActivityDeviceDetailsInfoVeichi extends AppCompatActivity {
  ...
  //  private TextView txtTotalEnergyHeadingID, txtConsumptionHeadingID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_device_details_info_veichi);
        mContext = this;
    ...
    private void initView() {
        ...
        rlvTabPVID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             /*   imgVFDId.setImageResource(R.drawable.iv_vfd_motor_blue);
                imgPVID.setImageResource(R.drawable.iv_vfd_motor_blue);
      ...
      //  txtConsumptionValueID = (TextView) findViewById(R.id.txtConsumptionValueID);
       ...
       // vMUserId = customerSearchesList.get(mPosition).getMUserId();
        ...
        if (clientid == 0) {
            ...
            SideMenuInitView(0);
          //  txtDeleteButtonID.setVisibility(View.VISIBLE);///original
        ...
        if (isLoginCheck.equalsIgnoreCase("true")) {
            if (isPumpCheck.equalsIgnoreCase("true")) {
               ...
               // txtMotorStatusIID.setText("Start");
                ...
                txtMotorStatusIID.setText(getString(R.string.st_Stop));
     ...
     //    addEnergyGraphFun();
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if(CustomUtility.isOnline(mContext)){
                    ...
                    mDatabaseHelperTeacher.getDeviceDATALOgerDATA(vDeviceType);
                }
            }
        });
        ...
        if(CustomUtility.isOnline(mContext)){
            ...
            //swipeRefresh.setRefreshing(false);
            mViechiDataResponse = mDatabaseHelperTeacher.getDeviceDATALOgerDATA(vDeviceType);
...
/******************************************************************************************/
                          ...
                          //  msg2.obj = "Device Delete Successfully .";
                            msg2.obj = getString(R.string.delete_msg_text);
                    ...
                    progressDialog.dismiss();
                    CustomUtility.isErrorDialog(mContext, "Error", getString(R.string.st_Pleasecheckinternetconnection));
                }
...
//                        editor.putString("key_time_zone_change", "Invalid");
    ...
    private void callTotalEnergyAndConjuptionAPI() {
            ...
            public void onSuccess(int APINumber, String Json, Object obj) {
                ...
                try {
                  ...
                  //  getTotalEndAndConsuptionsResponse(mTotalEndAndConsuptionsModelView);
                    ViechiDataModel mViechiDataModel = gson.fromJson(Json, ViechiDataModel.class);
                    getTotalEndAndConsuptionsResponse(mViechiDataModel);
                } catch (Exception e) {
                    swipeRefresh.setRefreshing(false);
                    e.printStackTrace();
                }
        ...
        try {
           ...
           // jsonObject.addProperty("DeviceType", mModelType);///Model type value
            jsonObject.addProperty("DeviceType", vDeviceType);//chnage by atul date 24-01-2020
        ...
        baseRequest.callAPIPost(1, jsonObject, NewSolarVFD.ORG_TOTAL_DATA_LOGGER_ENERGY);/////
    }

    private void getTotalEndAndConsuptionsResponse(ViechiDataModel mViechiDataModel) {
        ...
        if (mViechiDataModel.getStatus())
        {
            if(mViechiDataResponse != null )
                mViechiDataResponse = null;

           // mTotalEndAndConsuptionsModelView = mWelcomeModelView.getResponse();
            mViechiDataResponse = mViechiDataModel.getResponse();


            //total_fault = mTotalEndAndConsuptionsResponse.getTotalFault();
            current_fault = mViechiDataResponse.getTotalFault();
            if(mViechiDataResponse != null ){
                mDatabaseHelperTeacher.insertDeviceDATALOgerData(vMUserId, vMDeviceId, vDeviceNo, vDeviceType,mViechiDataResponse,mCheckFirst);
            }
    ...
    private Fragment callFragPV(Fragment fragment1) {
        ...
        fragment1 = new DashboardVeichiPVFragment(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType, mViechiDataResponse);
        return fragment1;
    }
    ...
    private Fragment callFragVFD(Fragment fragment1) {
        ...
        fragment1 = new DashboardVeichiMotorFragment(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType, mViechiDataResponse);
        return fragment1;
    }
