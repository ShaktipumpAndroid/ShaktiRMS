...
public class GetBTDATAListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_btdatalist);
        mContext = this;
        initView();
    }
...
*/
        ...
        rlvOneYearBTNID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new BluetoothCommunicationGetONEYearParameter().execute(":YLENGTH#", ":YLENGTH#", "START");
            }
        });
                            ...
                            for (int i = 0; i < mS.length; i++) {
                                ...
                                if (!mS[i].trim().equalsIgnoreCase("") || !mS[i].trim().equalsIgnoreCase(null)) {
                                    ...
                                    GetBTDATAListActivity.this.runOnUiThread(new Runnable() {
                                        @Override
                                        public void run() {
                                            new BluetoothCommunicationGetFaultParameter().execute(":DLENGTH#", ":DLENGTH#", "OKAY");
                                        }
                                    });

                                }

                              //  headerLenght = ""+mMonthHeaderList.size();
                        ...
                        if (mS.length > 0) {
                            ...
                            for (int i = 0; i < mS.length; i++) {
                             ...
                             //   headerLenght = ""+mMonthHeaderList.size();
                                ...
                                System.out.println("Vikas_headerLenghtMonth==>>"+headerLenghtMonth);
                            }
                        } else {
                            GetBTDATAListActivity.this.runOnUiThread(new Runnable() {
                                @Override
        ...
        protected void onPostExecute(Boolean result) //after the doInBackground, it checks if everything went fine
        {
            ...
            if (mMonthHeaderList.size() > 0) {
                ...
                GetBTDATAListActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        new BluetoothCommunicationGetONEYearParameter().execute(":YLENGTH#", ":MLENGTH#", "OKAY");
                    }
                });
            }
        }
...
// display dialog
    ...
    private void UploadFileToServerOption(final Context context) {
       ...
       /* builder.setNeutralButton("Fault",new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
...
// display dialog
    ...
    public void GetProfileUpdate_Task(String deviceno, String type, String len) {
        ...
        if (CustomUtility.isOnline(mContext)) {
           ...
           // RequestBody headerLenght1 = RequestBody.create(MediaType.parse("multipart/form-data"), headerLenght);
