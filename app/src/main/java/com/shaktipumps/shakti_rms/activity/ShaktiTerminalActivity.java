...
public class ShaktiTerminalActivity extends AppCompatActivity {
   ...
   // LinearLayout lvlMainTextContainerID;
    RelativeLayout lvlMainTextContainerID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shakti_terminal);
        mContext = this;
        initView();
    }
    ...
    private void initView() {
        ...
        lvlMainTextContainerID = (RelativeLayout) findViewById(R.id.lvlMainTextContainerID);
            ...
            public void onClick(View v) {
                ...
                if (!edtPutCommandID.getText().toString().isEmpty()) {
                  //  getTextViewTT(pp, edtPutCommandID.getText().toString());
                    ...
                    new BluetoothCommunicationForDebugStartType().execute(edtPutCommandID.getText().toString()+"", edtPutCommandID.getText().toString(), "Start");
                    ...
                    try {
                            ...
                            try {
                              ...
                              //  int mCharOne = 0;
                               // int mCharTwo = 0;
                                ...
                                try {
                                    mCharOne = (char) iStream.read()+"";
                                    mCharTwo = (char) iStream.read()+"";
                                } catch (IOException e) {
                                    e.printStackTrace();
                                }

                                String mkmkmm = mCharOne + "" +  mCharTwo;
                                    System.out.println("vikas--3==>" + mCharOne + "" + mCharTwo+ "===mkmkmm=="+mkmkmm);


                                    if ("TX".equalsIgnoreCase( mkmkmm)) {
                                   // if ("bT".equalsIgnoreCase( mCharOne + "" +  mCharTwo)) {
                                         baseRequest.hideLoader();
                                         break;
                                    }
                                    else
                                    {
                                      //  kkkkkk1 = (char) mCharOne + (char) mCharTwo + "";
                                        kkkkkk1 =  mCharOne +  mCharTwo + "";
                                        AllTextSTR = AllTextSTR + kkkkkk1;
                                        // AllTextSTR = AllTextSTR.replaceAll("[\\r]", "");
                                       // AllTextSTR = AllTextSTR.replaceAll("[\\n]", "");
                                        pppp++;
                                        System.out.println("pppppppp=="+pppp+"===>>"+kkkkkk1);
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ///  addHeadersMonths();
                                // AllCommomSTRContainer = AllCommomSTRContainer + "\n" + AllTextSTR;
                                System.out.println("ffffkkkkkk1===>>"+kkkkkk1);
                                lvlMainTextContainerID.addView(getTextViewTTppSingle(pp, "" + AllTextSTR));
                                scrlViewID.fullScroll(View.FOCUS_DOWN);
                                AllTextSTR = "";
                                // addDataMonth(mPostionFinal + 1, mvDay + "", mvMonth + "", mvYear + "", mvHour, mvMinute, mvNo_of_Start, fvFrequency, fvRMSVoltage, fvOutputCurrent, mvRPM, fvLPM, fvPVVoltage, fvPVCurrent, mvFault, fvInvTemp);
