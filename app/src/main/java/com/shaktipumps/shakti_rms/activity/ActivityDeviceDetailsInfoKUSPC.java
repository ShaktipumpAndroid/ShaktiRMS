...
import com.shaktipumps.shakti_rms.Interface.Uspcinternalrefreshinterface;
...
import com.shaktipumps.shakti_rms.bean.UspcEnergy.UspcEnrgyModel;
import com.shaktipumps.shakti_rms.bean.UspcEnergy.UspcEnrgyResponse;
import com.shaktipumps.shakti_rms.fragment.ApplicationOptionUSPCFragment;
import com.shaktipumps.shakti_rms.fragment.StartStopFragmentUSPC;
import com.shaktipumps.shakti_rms.fragment.Uspc.DashboardFragmentUspcGrid;
import com.shaktipumps.shakti_rms.fragment.Uspc.DashboardFragmentUspcMotor;
...
public class ActivityDeviceDetailsInfoKUSPC extends AppCompatActivity {
    ...
    RelativeLayout rlvTabConfigID;
    ImageView imgConfigID;
    TextView txtConfigID;


    private Uspcinternalrefreshinterface mUspcinternalrefreshinterface;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_device_details_info_klp_uspc);
        mContext = this;
    ...
    private void initView() {
        ...
        rlvTabConfigID = (RelativeLayout) findViewById(R.id.rlvTabConfigID);
        imgConfigID = (ImageView) findViewById(R.id.imgConfigID);
        txtConfigID = (TextView) findViewById(R.id.txtConfigID);
        ...
        txtHomeID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imgConfigID.setImageResource(R.drawable.settings_unselected);
                txtConfigID.setTextColor(getResources().getColor(R.color.dark_bg_grey));
        ...
        rlvTabConfigID.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                txtGraphID.setImageResource(R.drawable.settings_unselected);
                imgConfigID.setImageResource(R.drawable.settings_selected);
                //  txtGraphID.setTextColor(getResources().getColor(R.color.white));
                txtDataID.setImageResource(R.drawable.iv_vfd_motor_gray);
                txtHomeID.setImageResource(R.drawable.pv_gray);

                txtVfdID.setTextColor(getResources().getColor(R.color.dark_bg_grey));
                txtGridID.setTextColor(getResources().getColor(R.color.dark_bg_grey));
                txtSettingID.setTextColor(getResources().getColor(R.color.dark_bg_grey));
                txtConfigID.setTextColor(getResources().getColor(R.color.blue_fb));
                //   txtDataID.setTextColor(getResources().getColor(R.color.black));
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if (CustomUtility.isOnline(mContext)) {
                    ...
                    mUspcEnrgyResponse =   mDatabaseHelperTeacher.getDeviceUSPCDATA(vDeviceType);
                }
            }
        });
...
/******************************************************************************************/
    ...
    private void callTotalEnergyAndConjuptionAPI() {
        ...
        baseRequest.setBaseRequestListner(new RequestReciever() {
            ...
            public void onSuccess(int APINumber, String Json, Object obj) {
                ...
                try {
                    ...
                    mCheckFirst = true;
                    swipeRefresh.setRefreshing(false);
                    UspcEnrgyModel mUspcEnrgyModel = gson.fromJson(Json, UspcEnrgyModel.class);
                    getTotalEndAndConsuptionsResponse(mUspcEnrgyModel);
        ...
        baseRequest.callAPIPost(1, jsonObject, NewSolarVFD.USPCLIST_API);/////Two method
    }
    ...
    private void getTotalEndAndConsuptionsResponse(UspcEnrgyModel mUspcEnrgyModel) {
        ...
        if (mUspcEnrgyModel.getStatus()) {
            if (mUspcEnrgyResponse != null)
                mUspcEnrgyResponse = null;

            // mTotalEndAndConsuptionsModelView = mWelcomeModelView.getResponse();
            mUspcEnrgyResponse = mUspcEnrgyModel.getResponse();
            //total_fault = mTotalEndAndConsuptionsResponse.getTotalFault();
           // current_fault = mUspcEnrgyResponse.getTotalFault();
           // mDatabaseHelperTeacher.insertDeviceKLPData(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, mKLPTotEnergyResponse, mCheckFirst);

            mDatabaseHelperTeacher.insertDeviceUSPCData(vMUserId, vMDeviceId, vDeviceNo, vDeviceType,mUspcEnrgyResponse,mCheckFirst);
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    fragment = callFragAppication(fragment);
                    // fragment = callFragGraph(fragment);
                    break;
            }
            return fragment;
    ...
    private Fragment callFragHome(Fragment fragment1) {
        ...
        fragment1 = new DashboardFragmentUspcGrid(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType, mUspcEnrgyResponse);
        return fragment1;
    }
    ...
    private Fragment callFragVFD(Fragment fragment1) {
        ...
        fragment1 = new DashboardFragmentUspcMotor(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType, mUspcEnrgyResponse);
        return fragment1;
    }
    ...
    private Fragment callFrag(Fragment fragment1) {
        ...
        fragment1 = new StartStopFragmentUSPC(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType, txtMotorStatusIID, mUspcEnrgyResponse);
        return fragment1;
    }

    private Fragment callFragAppication(Fragment fragment1) {
        try {
        ...
        fragment1 = new ApplicationOptionUSPCFragment(vMUserId, vMDeviceId, vDeviceNo, vDeviceType, CustomerName, Mobile, total_fault, current_fault, isLoginCheck, isPumpCheck, mImageUrl, mModelType, txtMotorStatusIID,  customerSearchesList ,  mPosition, mUspcEnrgyResponse);
        return fragment1;
    }
