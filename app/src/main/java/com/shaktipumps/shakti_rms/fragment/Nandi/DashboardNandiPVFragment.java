...
public class DashboardNandiPVFragment extends Fragment {
    ...
    public DashboardNandiPVFragment() {
  ...
  //  public DashboardNandiPVFragment(String MUserId, String MDeviceId, String DeviceNo, String DeviceType, String CustomerName, String Mobile, float total_fault, int current_fault, String isLoginCheck, String isPumpCheck, String mImageUrl, String mModelType, ShimaResponse mShimaResponse, List<SimhaGraphViewResponse> mSimhaGraphViewResponse, TextView txtDateHeadingGraphID, TextView txtEnergyHeadingGraphID) {
    public DashboardNandiPVFragment(String MUserId, String MDeviceId, String DeviceNo, String DeviceType, String CustomerName, String Mobile, float total_fault, int current_fault, String isLoginCheck, String isPumpCheck, String mImageUrl, String mModelType, ShimaResponse mShimaResponse) {
        // Required empty public constructor
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_nandi_pv_dashboard, container, false);
