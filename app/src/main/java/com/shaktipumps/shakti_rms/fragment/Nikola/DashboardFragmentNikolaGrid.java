...
public class DashboardFragmentNikolaGrid extends Fragment {
...
private NikolaResponse mNikolaResponse;
    ...
    public DashboardFragmentNikolaGrid() {
        // Required empty public constructor
    }


    @SuppressLint("ValidFragment")
    public DashboardFragmentNikolaGrid(String MUserId, String MDeviceId, String DeviceNo, String DeviceType, String CustomerName, String Mobile, float total_fault, int current_fault, String isLoginCheck, String isPumpCheck, String mImageUrl, String mModelType, NikolaResponse mNikolaResponse) {
        // Required empty public constructor
    ...
    private ArrayList<BarDataSet> getDataSet() {
        ...
        for (int i = 0; i < mNikolaGraphEnergyResponse.size(); i++) {
            ...
            try {
                ...
                BarEntry v1e1 = new BarEntry(mNikolaGraphEnergyResponse.get(i).getTOTALGRIDEnergy(), i); // Jan
                valueSet1.add(v1e1);
