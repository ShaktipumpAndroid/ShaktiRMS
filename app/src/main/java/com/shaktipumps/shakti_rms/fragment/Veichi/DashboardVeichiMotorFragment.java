...
public class DashboardVeichiMotorFragment extends Fragment {
    ...
    private LinearLayout lvlTotalRHViewID;
    ...
    public DashboardVeichiMotorFragment() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public DashboardVeichiMotorFragment(String MUserId, String MDeviceId, String DeviceNo, String DeviceType, String CustomerName, String Mobile, float total_fault, int current_fault, String isLoginCheck, String isPumpCheck, String mImageUrl, String mModelType, ViechiDataResponse mViechiDataResponse) {
        // Required empty public constructor
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_veichi_motor_dashboard, container, false);
    ...
    private void initView() {
       ...
       // lvlTotalRHViewID = (LinearLayout) mView.findViewById(R.id.lvlTotalRHViewID) ;

        //lvlTotalRHViewID.setVisibility(View.GONE);
        ...
        try {
            ...
            txtTotalFlowNameID.setText(mViechiDataResponse.getTOTMFlowName());
            txtTotalFlowValueID.setText(mViechiDataResponse.getTOTMFlowValue());
            txtTotalFlowUnitNameID.setText(mViechiDataResponse.getTOTMFlowUnit());

            txtTotalRHNameID.setText(mViechiDataResponse.getTOTMRHrName());
            txtTotalHRValueID.setText(mViechiDataResponse.getTOTMRHrValue());
            txtTotalHRUnitID.setText(mViechiDataResponse.getTOTMRHrUnit());

            txtTodayFlowNameID.setText(mViechiDataResponse.getTDMFlowName());
            txtTodayFlowValueID.setText(mViechiDataResponse.getTDMFlowValue());
            txtTodayFlowUnitID.setText(mViechiDataResponse.getTDMFlowUnit());

            txtTodayHRNameID.setText(mViechiDataResponse.getTDMRHrName());
            txtTodayHRValueID.setText(mViechiDataResponse.getTDMRHrValue());
            txtTodayHRUnitID.setText(mViechiDataResponse.getTDMRHrUnit());
