...
import com.shaktipumps.shakti_rms.activity.GetBTDATAListActivity;
...
public class StartStopFragment extends Fragment {
    ...
    public StartStopFragment(String MUserId, String MDeviceId, String DeviceNo, String DeviceType, String CustomerName, String Mobile, float total_fault, int current_fault, String isLoginCheck, String isPumpCheck, String mImageUrl, String mModelType) {
        // Required empty public constructor
    ...
    @SuppressLint("ValidFragment")
    public StartStopFragment(String MUserId, String MDeviceId, String DeviceNo, String DeviceType, String CustomerName, String Mobile, float total_fault, int current_fault, String isLoginCheck, String isPumpCheck, String mImageUrl, String mModelType, TextView txtMotorStatusIID) {
        // Required empty public constructor
        this.MUserId = MUserId;
        this.DeviceNo = DeviceNo;
        this.mModelType = mModelType;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_start_stop, container, false);
        ...
        try {
            if (NewSolarVFD.OEM_NORMAL_USER_CHECK > 0) {
                if (mModelType.equalsIgnoreCase("8") || mModelType.equalsIgnoreCase("2")) {
                    ...
                    rlvStartStopBottomViewID.setWeightSum(3f);
                }else if (mModelType.equalsIgnoreCase("66")) {
                    //changeButtonVisibility(false, 0.5f, txtDataExtractionID);
                    crdDataExcViewID.setVisibility(View.VISIBLE);
                    crdSettingViewID.setVisibility(View.VISIBLE);
                ...
                if (mModelType.equalsIgnoreCase("8") || mModelType.equalsIgnoreCase("2")) {
                    ...
                    //changeButtonVisibility(false, 0.5f, txtDataExtractionID);
                    crdDataExcViewID.setVisibility(View.VISIBLE);
                    crdSettingViewID.setVisibility(View.GONE);//origenal
                    rlvStartStopBottomViewID.setWeightSum(2f);

                } else if (mModelType.equalsIgnoreCase("1")) {
                    //changeButtonVisibility(false, 0.5f, txtDataExtractionID);
                    crdDataExcViewID.setVisibility(View.VISIBLE);
                    crdSettingViewID.setVisibility(View.GONE);//original
                    crdSettingViewID.setVisibility(View.VISIBLE);
                    rlvStartStopBottomViewID.setWeightSum(3f);
                    ...
                    crdDataExcViewID.setVisibility(View.VISIBLE);
                    crdSettingViewID.setVisibility(View.VISIBLE);
                   // crdSettingViewID.setVisibility(View.GONE);//Original code
                    rlvStartStopBottomViewID.setWeightSum(3f);
                }else if (mModelType.equalsIgnoreCase("66")) {
                    //changeButtonVisibility(false, 0.5f, txtDataExtractionID);
                    crdDataExcViewID.setVisibility(View.VISIBLE);
            ...
            public void run() {
                ...
                if (CustomUtility.isOnline(mActivity)) {
                    ...
                    try {
                     ...
                     //   obj = CustomHttpClient.executeHttpPost1(NewSolarVFD.START_STOP_MOTOR, param);
                      //  obj = CustomHttpClient.executeHttpPost1(NewSolarVFD.START_STOP_MOTOR, param);
                        obj = CustomHttpClient.executeHttpPost1(NewSolarVFD.HOST_NAME3 + NewSolarVFD.START_STOP_MOTOR1, param);
                   ...
                   /* Gson gson = new Gson();
                    ...
                    if (mStatus.equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < ja.length(); i++) {
                            ...
                            StartStopVkResponse mmComplainAllResponse = new StartStopVkResponse();

                            mmComplainAllResponse.setMId(join.getString("MId"));
                            mmComplainAllResponse.setResult(join.getString("Result"));




                            mStartStopVkResponse.add(mmComplainAllResponse);
            ...
            public void run() {
                try {
                    if (CustomUtility.isOnline(getContext())) {
                        ...
                        progressDialog.dismiss();
                        CustomUtility.isErrorDialog(getContext(), "Error", getString(R.string.st_Pleasecheckinternetconnection));
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
