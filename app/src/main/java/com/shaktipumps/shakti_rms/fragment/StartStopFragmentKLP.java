...
import com.shaktipumps.shakti_rms.activity.BluetoothDataExtrctionVicheeActivity;
...
import com.shaktipumps.shakti_rms.activity.KLPDATAExtractionActivity;
...
public class StartStopFragmentKLP extends Fragment {

    int mTimerCounterCheck = 0;

    private CountDownTimer countDownTimer;
    TextView tvComonID;
    TextView txtCounterIDView;
    RelativeLayout rlvCounterViewID;
    ...
    String isLoginCheck, isPumpCheck;
    String mImageUrl;
    ...
    public StartStopFragmentKLP() {
        // Required empty public constructor
    }


    @SuppressLint("ValidFragment")
    public StartStopFragmentKLP(String MUserId, String MDeviceId, String DeviceNo, String DeviceType, String CustomerName, String Mobile, float total_fault, int current_fault, String isLoginCheck, String isPumpCheck, String mImageUrl, String mModelType) {
        // Required empty public constructor
    ...
    @SuppressLint("ValidFragment")
    public StartStopFragmentKLP(String MUserId, String MDeviceId, String DeviceNo, String DeviceType, String CustomerName, String Mobile, float total_fault, int current_fault, String isLoginCheck, String isPumpCheck, String mImageUrl, String mModelType, TextView txtMotorStatusIID) {
        // Required empty public constructor
        this.MUserId = MUserId;
        this.DeviceNo = DeviceNo;
        this.mModelType = mModelType;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_start_stop_klp, container, false);
    ...
    private void initView() {
        ...
        txtCounterIDView = (TextView) mView.findViewById(R.id.txtCounterIDView);
        rlvCounterViewID = (RelativeLayout) mView.findViewById(R.id.rlvCounterViewID);

        rlvCounterViewID.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        try {
           // if (NewSolarVFD.OEM_NORMAL_USER_CHECK > 0)
            if (NewSolarVFD.OEM_NORMAL_USER_CHECK == 0)
            {
                ...
                }else if ((mModelType.equalsIgnoreCase("71")) || (mModelType.equalsIgnoreCase("74"))) {
                    //changeButtonVisibility(false, 0.5f, txtDataExtractionID);
                    crdDataExcViewID.setVisibility(View.VISIBLE);
                    crdSettingViewID.setVisibility(View.VISIBLE);
                    rlvStartStopBottomViewID.setWeightSum(3f);
                ...
                } else if (mModelType.equalsIgnoreCase("95")) {
                    //changeButtonVisibility(false, 0.5f, txtDataExtractionID);
                    crdDataExcViewID.setVisibility(View.VISIBLE);
                    crdSettingViewID.setVisibility(View.VISIBLE);
                    rlvStartStopBottomViewID.setWeightSum(3f);

                } else if (mModelType.equalsIgnoreCase("87")) {
                    //changeButtonVisibility(false, 0.5f, txtDataExtractionID);
                    crdDataExcViewID.setVisibility(View.VISIBLE);
                    crdSettingViewID.setVisibility(View.VISIBLE);
                            ...
                            if (!Constant.BT_DEVICE_NAME.equalsIgnoreCase("") && !Constant.BT_DEVICE_MAC_ADDRESS.equalsIgnoreCase("")) {
                                if (Constant.BT_DEVICE_NAME.equalsIgnoreCase(DeviceNo)) {
                                    if (mModelType.equalsIgnoreCase("6")) {
                                        ...
                                        Intent intentP = new Intent(getActivity(), KLPDATAExtractionActivity.class);
                                        intentP.putExtra("BtNameHead", Constant.BT_DEVICE_NAME);
                                        intentP.putExtra("DeviceType", DeviceType);
                                        intentP.putExtra("ModelType", mModelType);
                                        intentP.putExtra("BtMacAddressHead", Constant.BT_DEVICE_MAC_ADDRESS);
...
*/
    ...
    public void CreateCardViewProgrammatically() {
        ...
        /*if(mDynamicBTNResponse.size() < 3) {
            lvlStartStopInnerMainViewID.setWeightSum(2);
        }*/
        for (int i = 0; i < mDynamicBTNResponse.size(); i++) {
            ...
            if (i == 0) {
                layoutparams.setMargins((int) getResources().getDimension(R.dimen._2sdp), 0, 0, (int) getResources().getDimension(R.dimen._1sdp));
            } else {
                layoutparams.setMargins((int) getResources().getDimension(R.dimen._11sdp), 0, 0, (int) getResources().getDimension(R.dimen._1sdp));
            }
            // layoutparams.setMargins((int) getResources().getDimension(R.dimen._5sdp), 0, (int) getResources().getDimension(R.dimen._5sdp), (int) getResources().getDimension(R.dimen._1sdp));
          //  cardview.setId(i + 1);
...
*/
        ...
        /*
                    ////write code here bobobobobobobo
                                ...
                                new AlertDialog.Builder(mActivity)
                                        ...
                                        .setPositiveButton(getString(R.string.st_Yes), new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                {
                                                    if(mTimerCounterCheck > 1)
                                                    {
                                                        rlvCounterViewID.setVisibility(View.VISIBLE);
                                                    }
                                                    else
                                                    {
                                                        baseRequest.showLoader();
      ...
      /*      if(mDynamicBTNResponse.size() > 2)
            {
                //   lvlStartStopInnerMainViewID.setWeightSum(2);
                 layoutparams.width= UtilMethod.getDeviceHeightWidth(mContext, true) / 2 - 50;
                cardview.setLayoutParams(layoutparams);
            }
            else
            {
...
//                }
        ...
        protected void onPostExecute(Boolean result) //after the doInBackground, it checks if everything went fine
        {
            ...
            if (mmCheckStart == 1) {
               ...
               {
                  // CustomUtility.isSuccessDialog(mActivity, mActivity.getString(R.string.success), "START SUCESSFULLY!");
                   CustomUtility.isSuccessDialog(mActivity, mActivity.getString(R.string.success), getString(R.string.succ_device_start));
               }
               else
               {
                  // CustomUtility.isSuccessDialog(mActivity, mActivity.getString(R.string.success), "STOP SUCESSFULLY!");
                   CustomUtility.isSuccessDialog(mActivity, mActivity.getString(R.string.success), getString(R.string.succ_device_stop));
               }
    ...
    private class BluetoothCommunicationForMotorStop extends AsyncTask<String, Void, Boolean>  // UI thread
    {
        ...
        protected void onPostExecute(Boolean result) //after the doInBackground, it checks if everything went fine
        {
            ...
            if (mmCheckStop == 1) {
                ...
                Toast.makeText(mActivity, getString(R.string.succ_device_stop), Toast.LENGTH_SHORT).show();
            }
        }
    }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (CustomUtility.isOnline(mActivity)) {
                    ...
                    msg.obj = getString(R.string.st_Pleasecheckinternetconnection);
    ...
    public void showMap() {
       ...
       // progressDialog.setTitle("Please wait..."); // Setting Title
         ...
         progressDialog.setMessage(getString(R.string.st_Loading)); // Setting Message
        progressDialog.setTitle(getString(R.string.st_Pleasewait)); // Setting Title
    ...
    private void callDynamicBTNAPI() {
        ...
        baseRequest.setBaseRequestListner(new RequestReciever() {
            ...
            public void onFailure(int APINumber, String errorCode, String message) {
                ...
                if("Empty List".equalsIgnoreCase(message))
                {
        ...
        System.out.println("ORG_PRODUCT_DYNAMIC_BTN==>>" + DeviceType);
    ...
    private void startTimer(long totalTimeCountInMilliseconds) {
        ...
        rlvCounterViewID.setVisibility(View.INVISIBLE);
        //changeButtonVisibilityRLV(false, 0.5f,txtCounterIDView);
        ...
        countDownTimer = new CountDownTimer(totalTimeCountInMilliseconds, 1000) {
            ...
            public void onTick(long leftTimeInMilliseconds) {
                ...
                txtCounterIDView.setText(String.format("%02d", seconds / 60)
                        + ":" + String.format("%02d", seconds % 60));
                mTimerCounterCheck = Integer.parseInt(String.format("%02d", seconds % 60));
            ...
            public void onFinish() {
                ...
                // tvComonIDD.setText("Start");
                rlvCounterViewID.setVisibility(View.GONE);
                // changeButtonVisibilityRLV(true, 1.0f,txtCounterIDView);
            }
        }.start();
    }
