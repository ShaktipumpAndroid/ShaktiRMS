...
import com.shaktipumps.shakti_rms.activity.BTDemoForMQTT;
import com.shaktipumps.shakti_rms.activity.LatLongForHaredaServerActivity;
import com.shaktipumps.shakti_rms.webservice.NewSolarVFD;

import java.util.List;


public class BTDemoMQTTAdapter extends RecyclerView.Adapter<BTDemoMQTTAdapter.ViewHolder> {
    ...
    private List mDeviceMACAddressList;
      ...
      String EXTRA_NAME = "device_name";
    //private HomeUserNameClickListener mHomeUserNameClickListener;

    public BTDemoMQTTAdapter(Context mContext, List mDeviceNameList, List mDeviceMACAddressList) {
    ...
    public BTDemoMQTTAdapter(String SSS, Context mContext) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.cardMainViewMyNotifyID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString(EXTRA_ADDRESS, Constant.BT_DEVICE_MAC_ADDRESS);
                editor.putString(EXTRA_NAME, Constant.BT_DEVICE_NAME);
                editor.apply();


               /* Intent i = new Intent(mContext, Dashboard_Activity.class);
                i.putExtra(EXTRA_ADDRESS, Constant.BT_DEVICE_MAC_ADDRESS);
                i.putExtra(EXTRA_NAME, Constant.BT_DEVICE_NAME);
               ...
               // Intent intent = new Intent(mContext, GetBTDATAListActivity.class);
                ...
                if(NewSolarVFD.CHECK_LAT_LONG_AND_MQTT  == 1)
                {
                    Intent intent = new Intent(mContext, LatLongForHaredaServerActivity.class);
                ...
                {
                    Intent intent = new Intent(mContext, BTDemoForMQTT.class);
