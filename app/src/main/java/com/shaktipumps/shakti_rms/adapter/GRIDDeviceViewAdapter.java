 ...
 */
public class GRIDDeviceViewAdapter extends BaseAdapter {
    ...
    public GRIDDeviceViewAdapter(Context context, List<Customer_GPS_Search> customerSearchesList) {
        mContext = context;
    ...
    @Override
    public int getCount() {
        if(customerSearchesList.size()> 0)
        {
...
/*        if (customerSearchesList.get(position).getIsLogin().equalsIgnoreCase("true")) {
            ...
            if (customerSearchesList.get(position).getPumpStatus().equalsIgnoreCase("true")) {
                ...
                if (customerSearchesList.get(position).getDeviceStatus() == 0) {
                    holder.imgMoterStatusID.setImageResource(R.mipmap.green_ball);//////////////

                    holder.OrderFiltercardViewID.setCardBackgroundColor(mContext.getResources().getColor(R.color.green_trans));

                } else if (customerSearchesList.get(position).getDeviceStatus() == 1) {
                    holder.imgMoterStatusID.setImageResource(R.mipmap.green_ball);//////////////

                    holder.OrderFiltercardViewID.setCardBackgroundColor(mContext.getResources().getColor(R.color.green_trans));

                } else if (customerSearchesList.get(position).getDeviceStatus() == 2) {
                    holder.imgMoterStatusID.setImageResource(R.mipmap.green_ball);//////////////

                    holder.OrderFiltercardViewID.setCardBackgroundColor(mContext.getResources().getColor(R.color.green_trans));

                } else if (customerSearchesList.get(position).getDeviceStatus() == 3) {
                    holder.imgMoterStatusID.setImageResource(R.mipmap.green_ball);//////////////

                    holder.OrderFiltercardViewID.setCardBackgroundColor(mContext.getResources().getColor(R.color.green_trans));

                } else if (customerSearchesList.get(position).getDeviceStatus() == 4) {
                    holder.imgMoterStatusID.setImageResource(R.mipmap.green_ball);//////////////

                    holder.OrderFiltercardViewID.setCardBackgroundColor(mContext.getResources().getColor(R.color.green_trans));

                } else if (customerSearchesList.get(position).getDeviceStatus() == 5) {
                    holder.imgMoterStatusID.setImageResource(R.mipmap.green_ball);//////////////

                    holder.OrderFiltercardViewID.setCardBackgroundColor(mContext.getResources().getColor(R.color.green_trans));

                } else if (customerSearchesList.get(position).getDeviceStatus() == 6) {
                    holder.imgMoterStatusID.setImageResource(R.mipmap.green_ball);//////////////

                    holder.OrderFiltercardViewID.setCardBackgroundColor(mContext.getResources().getColor(R.color.green_trans));

                } else if (customerSearchesList.get(position).getDeviceStatus() == 7) {
                    holder.imgMoterStatusID.setImageResource(R.mipmap.green_ball);//////////////
