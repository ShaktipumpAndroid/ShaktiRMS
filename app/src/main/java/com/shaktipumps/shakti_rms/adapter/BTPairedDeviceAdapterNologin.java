...
import com.shaktipumps.shakti_rms.activity.GetBTDATAWithoutLoginActivity;

import java.util.List;


public class BTPairedDeviceAdapterNologin extends RecyclerView.Adapter<BTPairedDeviceAdapterNologin.ViewHolder> {
    ...
    public BTPairedDeviceAdapterNologin(Context mContext, List mDeviceNameList, List mDeviceMACAddressList) {
    ...
    public BTPairedDeviceAdapterNologin(String SSS, Context mContext) {
