...
import com.shaktipumps.shakti_rms.activity.GetBTDebugDataActivity;

import java.util.List;


public class BTPairedDeviceAdapterDebugNologin extends RecyclerView.Adapter<BTPairedDeviceAdapterDebugNologin.ViewHolder> {
    ...
    public BTPairedDeviceAdapterDebugNologin(Context mContext, List mDeviceNameList, List mDeviceMACAddressList) {
    ...
    public BTPairedDeviceAdapterDebugNologin(String SSS, Context mContext) {
