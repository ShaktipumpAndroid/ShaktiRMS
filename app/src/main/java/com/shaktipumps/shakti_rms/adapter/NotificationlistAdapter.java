...
public class NotificationlistAdapter extends RecyclerView.Adapter<NotificationlistAdapter.ViewHolder> {
  ...
  /*  // public USPCBridgeAdapter(List<MenuModelResponse> menuModelsList, Activity mContext)
    public NotificationlistAdapter(Context mContext, PayUSdkDetails payUSdkDetails, List<Customer_GPS_Search> customerSearchesList, List<PaymentPlanResponse> mPaymentPlanResponse, int mPosition, String MUserId, String DeviceNo, String mModelType, String DeviceType) {
 ...
 public NotificationlistAdapter(Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view1 = LayoutInflater.from(mContext).inflate(R.layout.notification_item_view, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.txtPayDescNameID.setText("");
        holder.txtPaymentValueID.setText("");
        holder.txtPayEXPHEADID.setText("");
