...
import com.shaktipumps.shakti_rms.activity.BTDemoBigDataActivity;

import java.util.List;


public class AoneSSBTPairedDeviceAdapternologin extends RecyclerView.Adapter<AoneSSBTPairedDeviceAdapternologin.ViewHolder> {
    ...
    public AoneSSBTPairedDeviceAdapternologin(Context mContext, List mDeviceNameList, List mDeviceMACAddressList) {
    ...
    public AoneSSBTPairedDeviceAdapternologin(String SSS, Context mContext) {
